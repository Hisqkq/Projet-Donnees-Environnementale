...
Vous pouvez cliquer sur les différentes années puis sur les différents MOS pour zoomer et obtenir plus d'informations sur la présence des espèces d'oiseaux dans un moss d'une année spécifique. 
La présence d'une espèce d'oiseau dans un MOSS est calculée en fonction du nombre d'oiseaux observés dans une parcelle multiplié par le pourcentage du MOS en question dans la parcelle. Les parcelles ont été filtré en ne gardant que celles avec un buffer size de 500.
...
Ceci est très utile lorsqu'on veut étudier la répartition des espèces d'oiseau ou regarder la présence d'une espèce dans un MOSS et une année que l'on veut étudier. On peut aussi
...
<center>
  ![Zoom sur le Sunburst pour l'année 2023 et le Moss 11](./images/sunburst2023MOSS11.png)
</center>
